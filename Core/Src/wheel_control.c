...
#define SCURVE_MAX_DEC_CPS2 200000
#define SCURVE_MAX_JERK_CPS3 900000
#define SCURVE_TRACK_GAIN_NUM 6
#define SCURVE_TRACK_GAIN_DEN 10
#define SCURVE_FAST_ERR_CPS 1200
#define SCURVE_MIN_ACC_CPS2 300
#define SCURVE_SNAP_ERR_CPS 10
#define SPEED_EPS_CPS 20
#define ACC_EPS_CPS2 100
#define STOP_HOLD_CPS 80
#define PWM_OUT_SLEW_UP_UNITS_PER_SEC 9000
#define PWM_OUT_SLEW_DOWN_UNITS_PER_SEC 14000
